...
package com.iflytek.luoluo.oknet;
...
import com.iflytek.luoluo.apiluoluo.com.axino.accessPlatform.service.OpenApiV1;
...
public class ApiUse {
    ...
    private static String shuihao = com.axino.accessPlatform.util.StateData.user_Tax;
    ...
    public static void main(String[] args) {
        ...
        String result = "";
        try {
            result = sdk.handle(com.axino.accessPlatform.util.StateData.url, headers, requestMode);
